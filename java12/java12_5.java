...
class Human extends Animal {
    int length; //, z
    Human(String name, int length) {super(name); this.length = length; }
    @Override void introduce() { super.introduce(); System.out.println(length + " メートル歩きました。"); }
}
class java12_5 {
