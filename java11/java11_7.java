...
class java11_7 {
    public static void main(String[] args) {        
        ...
        // // 結果を表示
        System.out.printf(eisann.getNumber() +"番　"+ eisann.getName() + "　平均点%.2f\n",aaa);
        System.out.printf(biisann.getNumber() +"番　"+ biisann.getName() + "　平均点%.2f\n",bbb);
        System.out.printf(siisann.getNumber() +"番　"+ siisann.getName() + "　平均点%.2f\n",ccc);
    }
}
